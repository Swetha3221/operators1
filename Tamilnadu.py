...
senior_players = 6
junior_players = 5
senior_contribution_percentage = 0.50
junior_contribution_percentage = 0.40


total_senior_contribution = (X * senior_contribution_percentage) * senior_players
total_junior_contribution = (Y * junior_contribution_percentage) * junior_players

total_contribution = total_senior_contribution + total_junior_contribution
